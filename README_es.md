...
### Configuración de modelos
- **Modelo principal**: `LongCat-Flash-Chat`
- **Modelo rápido**: `LongCat-Flash-Chat`

### Obtener tu clave API
- **Plataforma**: [https://longcat.chat/platform/api_keys](https://longcat.chat/platform/api_keys)
